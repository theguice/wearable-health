...
class BasisExport
{
    ...
    */
    function getActivities($export_date = '', $export_format = 'json')
    {
        ...
        if ($export_format == 'html') {
            ...
            $file = dirname(__FILE__) . '/data_basis/basis-' . $this->username . '-' . $export_date . '-basis.html';
            ...
            $file = dirname(__FILE__) . '/data_basis/basis-' . $this->username . '-' . $export_date . '-basis.csv';
            ...
            $file = dirname(__FILE__) . '/data_basis/basis-' . $this->username . '-' . $export_date . '-basis.json';
    ...
    */
    function testConfig()
    {
        ...
        echo "data_basis/ writable: ", is_writable('/data_basis') ? "yes":"NO", "\n";
