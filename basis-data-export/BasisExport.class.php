    ...
    */
    function getActivities($export_date = '', $export_format = 'json')
    {
        ...
        if ($export_format == 'html') {
            ...
            $file = dirname(__FILE__) . '/data/basis-data-' . $this->username . '-' . $export_date . '.html';
            ...
            $file = dirname(__FILE__) . '/data/basis-data-' . $this->username . '-' . $export_date . '.csv';
            ...
            $file = dirname(__FILE__) . '/data/basis-data-' . $this->username . '-' . $export_date . '.json';
